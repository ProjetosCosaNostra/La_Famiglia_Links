...
try{
  ...
  const showcase=[];
  for(const imgX of [-42,-40,-38,-36,-34]){
    for(const imgY of [-21,-19,-17,-15,-13]){
      for(const scale of [1.30,1.32,1.34,1.36,1.38]){
        ...
        showcase.push({id,top,height,imgX,imgY,scale,alpha,profile:"extra-wide-deeper"});
      }
    }
  }
