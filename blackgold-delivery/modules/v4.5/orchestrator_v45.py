...
ACTIONS = {
    ...
    "experience.promote_affiliate_candidate": "tools/blackgold_affiliate_activation_v45/promote_candidate.py",
}
    ...
    for _, _, p, t in sorted(tasks):
        ...
        if valid:
            ...
            res = run([sys.executable, str(tool), "--root", str(root)], root,
                ...
                "passed": False, "exit_code": 1, "stdout": "", "stderr": "allowlisted tool missing"
            }
        else:
            res = {"passed": False, "exit_code": 1, "stdout": "", "stderr": "task blocked by allowlist"}
