...
html = html.replace('</head>', '<link rel="stylesheet" href="./blackgold-home-v19-authority.css?v=20260908-v19-2"/></head>');
await fs.writeFile(index, html, 'utf8');
console.log(`BlackGold V19.2 mobile hero authority materialized: ${expectedSize} bytes ${expectedSha256}`);
